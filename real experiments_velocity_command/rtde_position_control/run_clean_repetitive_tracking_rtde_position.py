...
def parse_args():
    ...
    parser.add_argument('--command-delta-limit', type=float, default=0.0)
    parser.add_argument('--command-accel-limit', type=float, default=0.0)
    parser.add_argument('--command-jerk-limit', type=float, default=0.0)
