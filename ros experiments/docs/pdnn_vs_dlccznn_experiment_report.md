...
`/tmp/ros1_win-_control_diag/ros experiments/results/clean/20260607_135745/pdnn_vs_dlccznn_all_summaries.csv`

下面列出按平均位置误差排序的前若干项。

| Experiment | Trajectory | Solver | PDNN steps | Mean position error (m) | Final drift (rad) | Runtime (s) |
|---|---:|---:|---:|---:|---:|---:|
| single_circle_method2_dlccznn_live | circle | dlccznn | 1 | 1.564594e-02 | 7.671380e-02 | 10.000 |
